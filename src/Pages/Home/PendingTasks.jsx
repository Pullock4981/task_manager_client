  ...
  if (!user?.email) {
    return (
      <div className="text-center py-10">
        <p className="text-red-600 font-semibold">You must be logged in to view your tasks.</p>
        <button
          onClick={() => navigate("/login")}
          className="mt-4 btn bg-primary text-white px-6 py-2 rounded-md hover:bg-purple-700 transition"
        >
          Go to Login
        </button>
      </div>
