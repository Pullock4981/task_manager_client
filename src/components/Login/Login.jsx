            ...
            <div className="card bg-base-100 w-full max-w-sm shadow-xl">
                <div className="card-body">
                    ...
                    <form className="form-control w-full space-y-4">
                        ...
                        <button type="submit" className="btn btn-block bg-white text-[#2563EB] font-bold border border-[#2563EB] hover:bg-[#2563EB] hover:text-white transition duration-200">
                            Log In
                        </button>
                    ...
                    <button  className="btn btn-block bg-white text-black border border-[#e5e5e5] hover:shadow-md transition duration-200">
